...
find by_name -mindepth 2 -type f -and -not -name "*.avi" -and -not -name "*.m4v" -and -not -name "*.mp4" -and -not -name "*.wmv" -and -not -name "*.mov" -and -not -name "*.flv" -and -not -name "*.mkv" -and -not -name "*.webm"
